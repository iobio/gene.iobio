  ...
  <v-card v-show="selectedVariant" id="variant-inspect" class="app-card full-width">
    ...
    <div class="variant-inspect-body">
      ...
      <div class="variant-inspect-column" v-if="selectedVariant && info">
          ...
          <variant-inspect-row v-if="info.revel != '' && info.revel && !isBasicMode && !isSimpleMode"
            :clazz="getRevelClass(info)" :value="info.revel"   :label="`REVEL`" >
          </variant-inspect-row>
          <variant-inspect-row v-if="selectedVariant.alphamissenseScore != '' && !isBasicMode && !isSimpleMode"
          ...
          <variant-inspect-row v-if="selectedVariant.eve != '' && !isBasicMode && !isSimpleMode"
          ...
          <variant-inspect-row v-if="selectedVariant.caddPhred != '' && !isBasicMode && !isSimpleMode"
    ...
    afGnomAD: function() {
      if (this.selectedVariant) {
        ...
        if (this.selectedVariant.gnomAD.genomes.af  == '.') {
          ...
          gnomAD.totalCount    = this.selectedVariant.gnomAD.genomes.totalCount;
          gnomAD.homCount      = this.selectedVariant.gnomAD.genomes.homCount;
