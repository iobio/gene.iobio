...
<div>
  <svg id="symbols" xmlns="http://www.w3.org/2000/svg" style="display: none;">
    ...
    <symbol  id="denovo-symbol" viewBox="0 0 27 27" enable-background="new 0 0 28 28" xml:space="preserve">
      <circle fill="#C1272D" stroke="#000000" stroke-miterlimit="10" cx="8" cy="4" r="3.5"/>
      <circle fill="#FFFFFF" stroke="#000000" stroke-miterlimit="10" cx="17" cy="4" r="3.5"/>
      <g>
        <path fill="#717171" d="M7.8,11.1c1-0.2,2.3-0.3,3.7-0.3c2.3,0,3.8,0.4,5,1.3c1.3,0.9,2.1,2.4,2.1,4.6c0,2.3-0.8,3.9-2,4.9
          c-1.3,1.1-3.2,1.6-5.6,1.6c-1.4,0-2.4-0.1-3.1-0.2V11.1z M10.6,21c0.2,0.1,0.6,0.1,1,0.1c2.5,0,4.1-1.4,4.1-4.2
          c0-2.5-1.5-3.9-3.8-3.9c-0.6,0-1,0.1-1.2,0.1V21z">
        </path>
      </g>
    </symbol>
    ...
    <symbol  id="recessive-symbol" viewBox="0 0 27 27" enable-background="new 0 0 28 28" xml:space="preserve">
    ...
    <symbol id="denovo-symbol1" width="32" height="32"  viewBox="0 0 32 32">
      <g>
        <path fill="rgba(173, 38, 38, 0.65)" d="M7.3,22.4c-3.4,0-6.3-2.8-6.3-6.3v-0.2c0-3.4,2.8-6.3,6.3-6.3h0.2c3.4,0,6.3,2.8,6.3,6.3v0.2
          c0,3.4-2.8,6.3-6.3,6.3H7.3z"/>
        <path d="M7.5,10.5c3,0,5.4,2.4,5.4,5.4v0.2c0,3-2.4,5.4-5.4,5.4H7.3c-3,0-5.4-2.4-5.4-5.4v-0.2c0-3,2.4-5.4,5.4-5.4H7.5 M7.5,8.8
          H7.3c-3.9,0-7.1,3.2-7.1,7.1v0.2c0,3.9,3.2,7.1,7.1,7.1h0.2c3.9,0,7.1-3.2,7.1-7.1v-0.2C14.7,12,11.5,8.8,7.5,8.8L7.5,8.8z"/>
      </g>
      <g>
        <path fill="#ffffff" d="M23.3,22.5c-3.5,0-6.4-2.9-6.4-6.4v-0.2c0-3.5,2.9-6.4,6.4-6.4h0.2c3.5,0,6.4,2.9,6.4,6.4v0.2
          c0,3.5-2.9,6.4-6.4,6.4H23.3z"/>
        <path d="M23.6,10.2c3.1,0,5.6,2.5,5.6,5.6v0.2c0,3.1-2.5,5.6-5.6,5.6h-0.2c-3.1,0-5.6-2.5-5.6-5.6v-0.2c0-3.1,2.5-5.6,5.6-5.6H23.6
           M23.6,8.8h-0.2c-3.9,0-7.1,3.2-7.1,7.1v0.2c0,3.9,3.2,7.1,7.1,7.1h0.2c3.9,0,7.1-3.2,7.1-7.1v-0.2C30.7,12,27.5,8.8,23.6,8.8
          L23.6,8.8z"/>
      </g>
      <line fill="none" stroke="#000000" stroke-width="2" stroke-miterlimit="10" x1="4.4" y1="7" x2="0.8" y2="2"/>
      <line fill="none" stroke="#000000" stroke-width="2" stroke-miterlimit="10" x1="10.9" y1="7" x2="13.8" y2="2"/>
      <line fill="none" stroke="#000000" stroke-width="2" stroke-miterlimit="10" x1="7.3" y1="6.8" x2="7.3" y2="1.2"/>

    </symbol>


    <symbol  id="recessive-symbol1" width="32" height="32" viewBox="0 0 32 32" enable-background="new 0 0 32 32" xml:space="preserve">
      <g>
        <path fill="rgba(173, 38, 38, 0.65)" d="M7.3,22.5c-3.5,0-6.4-2.9-6.4-6.4v-0.2c0-3.5,2.9-6.4,6.4-6.4h0.2c3.5,0,6.4,2.9,6.4,6.4v0.2
          c0,3.5-2.9,6.4-6.4,6.4H7.3z"/>
        <path d="M7.5,10.2c3.1,0,5.6,2.5,5.6,5.6v0.2c0,3.1-2.5,5.6-5.6,5.6H7.3c-3.1,0-5.6-2.5-5.6-5.6v-0.2c0-3.1,2.5-5.6,5.6-5.6H7.5
           M7.5,8.8H7.3c-3.9,0-7.1,3.2-7.1,7.1v0.2c0,3.9,3.2,7.1,7.1,7.1h0.2c3.9,0,7.1-3.2,7.1-7.1v-0.2C14.7,12,11.5,8.8,7.5,8.8L7.5,8.8
          z"/>
      </g>
      <g>
        <path fill="rgba(173, 38, 38, 0.65)" d="M23.5,22.5c-3.5,0-6.4-2.9-6.4-6.4v-0.2c0-3.5,2.9-6.4,6.4-6.4h0.2c3.5,0,6.4,2.9,6.4,6.4v0.2
          c0,3.5-2.9,6.4-6.4,6.4H23.5z"/>
        <path d="M23.7,10.2c3.1,0,5.6,2.5,5.6,5.6v0.2c0,3.1-2.5,5.6-5.6,5.6h-0.2c-3.1,0-5.6-2.5-5.6-5.6v-0.2c0-3.1,2.5-5.6,5.6-5.6H23.7
           M23.7,8.8h-0.2c-3.9,0-7.1,3.2-7.1,7.1v0.2c0,3.9,3.2,7.1,7.1,7.1h0.2c3.9,0,7.1-3.2,7.1-7.1v-0.2C30.8,12,27.6,8.8,23.7,8.8
          L23.7,8.8z"/>
      </g>
    </symbol>


    <symbol id="danger-symbol" viewbox="0 0 612 612" height="612" width="612">
    ...
    <symbol id="biohazard-symbol" viewbox="0 0 106 106" height="106" width="106">
      <path  d="M68.361,49.047c0.332,1.279,0.564,2.6,0.564,3.977c0,7.291-4.966,13.391-11.677,15.26
      c-0.165-3.313,0.528-6.777,2.17-10.081l-2.62-1.513c-0.958,0.974-2.294,1.59-3.775,1.59c-1.473,0-2.809-0.616-3.774-1.59
      l-2.579,1.492c1.654,3.313,2.351,6.804,2.174,10.123c-6.734-1.849-11.728-7.97-11.728-15.281c0-1.396,0.233-2.721,0.572-4.002
      c2.944,1.494,5.605,3.801,7.64,6.861l2.661-1.538c-0.111-0.45-0.269-0.885-0.269-1.372c0-2.462,1.701-4.44,3.977-5.038v-3.045
      c-3.689-0.228-7.037-1.377-9.82-3.189c2.874-2.822,6.804-4.578,11.141-4.578c4.334,0,8.27,1.755,11.148,4.583
      c-2.775,1.802-6.12,2.957-9.817,3.185v3.045c2.278,0.598,3.977,2.576,3.977,5.038c0,0.487-0.145,0.922-0.274,1.372l2.703,1.564
      C62.785,52.848,65.436,50.543,68.361,49.047z M106.048,21.209v63.629c0,11.666-9.543,21.21-21.21,21.21H21.209
      C9.543,106.048,0,96.504,0,84.838V21.209C0,9.543,9.543,0,21.209,0h63.628C96.505,0,106.048,9.543,106.048,21.209z M92.792,52.972
      c0-21.295-16.694-38.634-37.697-39.716c9.279,0.88,16.487,7.625,16.487,15.821c0,2.812-0.927,5.414-2.418,7.705
      c-4.147-4.119-9.844-6.669-16.146-6.669c-6.289,0-11.99,2.55-16.13,6.669c-1.496-2.296-2.423-4.893-2.423-7.705
      c0-8.197,7.21-14.941,16.49-15.821c-21.002,1.082-37.699,18.421-37.699,39.716c0,6.427,1.559,12.479,4.259,17.854
      c-3.692-8.409-1.444-17.872,5.562-21.917c2.439-1.411,5.165-1.908,7.894-1.755c-0.507,1.882-0.857,3.829-0.857,5.869
      c0,10.579,7.236,19.413,16.992,22.043c-0.147,0.223-0.311,0.44-0.44,0.668c-0.01,0.021-0.01,0.037-0.016,0.058
      c-0.313,0.72-0.735,1.3-1.204,1.808c-1.054,1.366-2.268,2.594-3.816,3.489c-7.042,4.07-16.402,1.243-21.826-6.25
      c7.117,10.807,19.327,17.953,33.22,17.953c13.764,0,25.886-7.001,33.026-17.637c-5.447,7.254-14.639,9.941-21.582,5.938
      c-2.455-1.424-4.246-3.567-5.474-6.042c9.729-2.646,16.948-11.47,16.948-22.028c0-2.04-0.353-3.987-0.859-5.874
      c2.755-0.166,5.488,0.334,7.942,1.755c6.805,3.933,9.114,12.953,5.873,21.176C91.362,64.892,92.792,59.103,92.792,52.972z"/>
    </symbol>


    <symbol id="clinvar-symbol" width="13" height="13" viewBox="0 0 16 16">
    ...
    <symbol id="af-symbol" width="18" height="16" viewBox="0 0 18 16">
    ...
    <symbol  id="arrow-symbol" viewBox="0 0 80.4 10" width="80" height="80">
      <g>
    ...
    <symbol id="checkmark-symbol" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512" enable-background="new 0 0 512 512" xml:space="preserve">
    ...
    <symbol id="report-problem-symbol" viewBox="0 0 24 24" width="24" height="24" >
      <path d="M15.73 3H8.27L3 8.27v7.46L8.27 21h7.46L21 15.73V8.27L15.73 3zM12 17.3c-.72 0-1.3-.58-1.3-1.3 0-.72.58-1.3 1.3-1.3.72 0 1.3.58 1.3 1.3 0 .72-.58 1.3-1.3 1.3zm1-4.3h-2V7h2v6z"/>
      <path d="M0 0h24v24H0z" fill="none"/>
    </symbol>

    <symbol height="32" id="bookmark-symbol" viewBox="0 0 32 32" width="32" >
      <path d="M6 2 L26 2 L26 30 L16 24 L6 30 Z"/>
    </symbol>

    <symbol id="star-symbol" enable-background="new 0 0 50 50" height="50px" viewBox="0 0 50 50" width="50px">
    ...
    <symbol id="phenotype-symbol" width="24" height="24" viewBox="0 0 24 24">
    ...
    <symbol  id="somatic-symbol"
     viewBox="0 0 502.664 502.664" style="enable-background:new 0 0 502.664 502.664;">
      <g>
    ...
    <symbol id="arrow-down-symbol"  height="24" viewBox="0 0 24 24" width="24">
      <path d="M7 10l5 5 5-5z" />
    </symbol>

    <symbol id="arrow-up-symbol" height="24" viewBox="0 0 24 24" width="24" >
      <path d="M7 14l5-5 5 5z"  />
    </symbol>

    <symbol id="error-symbol" height="18" viewBox="0 0 24 24" width="24" >
      <path d="M0 0h24v24H0z" fill="none"/>
      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z"/>
    </symbol>

    <symbol id="error-outline-symbol" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
        <path d="M0 0h24v24H0V0z" fill="none"/>
        <path d="M11 15h2v2h-2zm0-8h2v6h-2zm.99-5C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"/>
    </symbol>

    <symbol id="trending-down-symbol" viewBox="0 0 24 24" width="24" height="24">
    ...
    <symbol id="warning-symbol"  height="24" viewBox="0 0 24 24" width="24">
        <path d="M0 0h24v24H0z" fill="none"/>
        <path d="M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z"/>
    </symbol>

    <symbol id="search-dna-symbol" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 48.26 48.259" style="enable-background:new 0 0 48.26 48.259;" xml:space="preserve">
      <g>
    ...
    <symbol id="loss-symbol" x="0px" y="0px" viewBox="0 0 486.115 486.115" style="enable-background:new 0 0 486.115 486.115;" xml:space="preserve" width="512px" height="512px">
      <g>
    ...
    <symbol id="low-signal-symbol" x="0px" y="0px" viewBox="0 0 12.667 12.667" style="enable-background:new 0 0 12.667 12.667;" xml:space="preserve" width="512px" height="512px">
        <g>
          <g>
            <path d="M7.196,12.667H5.45c-0.443,0-0.803-0.36-0.803-0.804V2.986c0-0.443,0.359-0.803,0.803-0.803h1.746     c0.443,0,0.803,0.36,0.803,0.803v8.876C8,12.306,7.641,12.667,7.196,12.667z M5.817,11.498h1.015V3.353H5.817V11.498z" />
          </g>
          <g>
            <path d="M3.106,12.667H1.36c-0.443,0-0.803-0.36-0.803-0.804V6.494c0-0.443,0.36-0.804,0.803-0.804h1.746     c0.443,0,0.803,0.36,0.803,0.804v5.369C3.909,12.306,3.549,12.667,3.106,12.667z" />
          </g>
          <g>
            <path d="M11.308,12.667H9.562c-0.443,0-0.803-0.36-0.803-0.804V0.803C8.759,0.361,9.118,0,9.562,0h1.746     c0.441,0,0.802,0.36,0.802,0.803v11.06C12.11,12.306,11.75,12.667,11.308,12.667z M9.929,11.498h1.013V1.169H9.929V11.498z" />
          </g>
        </g>
    </symbol>
    ...
    <symbol id="lightning-symbol" xmlns="http://www.w3.org/2000/svg"  width="49.652px" height="49.652px" viewBox="0 0 49.652 49.652" style="enable-background:new 0 0 49.652 49.652;" xml:space="preserve">
      <g>
        <path d="M24.826,0C11.137,0,0,11.137,0,24.826c0,13.688,11.137,24.826,24.826,24.826c13.688,0,24.826-11.138,24.826-24.826
          C49.652,11.137,38.516,0,24.826,0z M21.594,40.527l2.892-12.302h-8.402L22.3,12.289l0.443-1.166h7.916l-0.514,1.172l-4.34,10.391
          h7.762L21.594,40.527z"/>
      </g>
    </symbol>


    <symbol id="feedback-symbol" width="510px" height="510px" viewBox="0 0 510 510" style="enable-background:new 0 0 510 510;" xml:space="preserve">
      <g>
          <path d="M459,0H51C22.95,0,0,22.95,0,51v459l102-102h357c28.05,0,51-22.95,51-51V51C510,22.95,487.05,0,459,0z M280.5,306h-51v-51
            h51V306z M280.5,204h-51V102h51V204z">
          </path>
      </g>
    </symbol>
  </svg>
