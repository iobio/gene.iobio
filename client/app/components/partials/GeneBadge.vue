  ...
  computed: {
    classObject: function () {
      return {
        ...
        'inheritance-recessive': this.gene.dangerSummary && this.gene.dangerSummary.INHERITANCE &&this.gene.dangerSummary.INHERITANCE.recessive,
        'inheritance-denovo':    this.gene.dangerSummary && this.gene.dangerSummary.INHERITANCE && this.gene.dangerSummary.INHERITANCE.denovo,
