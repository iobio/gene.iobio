...
VariantTooltip.prototype.fillAndPositionTooltip = function(tooltip, variant, lock, coord, relationship, affectedInfo, cohortMode, maxAlleleCount, html) {
  var me = this;
  ...
  if (html == null) {
    if (lock) {
      html = variantTooltip.formatContent(variant, null, 'tooltip-wide', null, null, null, relationship, lock);
    } else {
      var pinMessage = "click on variant for more details";
      html = variantTooltip.formatContent(variant, pinMessage, null, null, null, null, relationship, lock);
    }
  }
  tooltip.html(html);
...
VariantTooltip.prototype.formatContent = function(variant, pinMessage, type, rec, geneObject, theTranscript, relationship, lock) {
  var me = this;
...
VariantTooltip.prototype._linksRow = function(variant, pinMessage, relationship, lock) {
  if (pinMessage == null) {
...
VariantTooltip.prototype.createAlleleCountSVGTrio = function(container, variant, relationship, affectedInfo, cohortMode, maxAlleleCount, barWidth) {
  var me = this;
